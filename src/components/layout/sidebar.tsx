...
const navItems: NavItem[] = [
  ...
  { href: '/scheduled-messages', labelKey: 'scheduledMessages', icon: Clock },
  { href: '/groups', labelKey: 'groups', icon: Users },
  { href: '/group-broadcasts', labelKey: 'groupBroadcasts', icon: Megaphone },
  { href: '/ad-links', labelKey: 'adLinks', icon: Link2 },
  { href: '/bio-link', labelKey: 'bioLink', icon: IdCard },
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          ...
          <ul className="flex flex-col gap-1">
            {/* Operator console. Hidden from everyone else purely to keep
                the nav honest — `requirePlatformAdmin()` guards every
                /api/admin/* call, so this link is a shortcut, never a
                permission. */}
