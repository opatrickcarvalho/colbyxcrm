...
async function processMessage(
  ...
  // Everything that happens *after* the message is stored — broadcast
  // reply flag, Flows, automations, AI auto-reply, message.received —
  // is shared with the UAZAPI webhook. It lived inline here until the
  // second provider arrived, which meant none of it ran for UAZAPI.
