...
// unchanged, so the UI silently drops the edit. That is how a step
// nested under a condition went uneditable: every keystroke in it was
// a no-op.
//
 ...
 * doesn't have, so the update was dropped.
 */
