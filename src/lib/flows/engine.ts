...
async function findEntryFlow(
  ...
  // could be answering. What it actually blocked was an automation
  // sending buttons whose reply keyword matched a flow: the flow never
  // started. Retyping the label by hand worked, which is the tell —
  // same words, different envelope.
