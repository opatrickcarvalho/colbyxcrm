...
export async function engineSendText(
  ...
  // The phone-variant retry that used to be inlined here now lives in
  // the Meta adapter — it is Meta-specific, and `deliveredTo` reports
  // back whichever variant the backend accepted.
